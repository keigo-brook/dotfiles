...
(defun dotspacemacs/user-config ()
  ...
  ;; split window by display size
  (defun split-window-vertically-n (num_winds)
    (interactive "p")
    (if (= num_winds 2)
        (split-window-vertically)
      (progn
        (split-window-vertically
         (- (window-height) (/ (window-height) num_winds)))
        (split-window-vertically-n (- num_winds 1)))))
  (defun  split-window-horizontally-n (num_winds)
    (interactive "p")
    (if (= num_winds 2)
        (split-window-horizontally)
      (progn
        (split-window-horizontally
         (- (window-width) (/ (window-width) num_winds)))
        (split-window-horizontally-n (- num_winds 1)))))
